...
def test_delay_features_use_prior_history(tmp_path, monkeypatch):
    ...
    po = pd.DataFrame([
        {"po_id":"1","supplier_id":"S1","part_id":"P1","order_date":"2026-01-01","promised_date":"2026-01-05","actual_delivery_date":"2026-01-05","quantity":10,"unit_price":5,"status":"delivered"},
        {"po_id":"2","supplier_id":"S1","part_id":"P1","order_date":"2026-01-10","promised_date":"2026-01-14","actual_delivery_date":"2026-01-17","quantity":20,"unit_price":5,"status":"delivered"},
    ])
